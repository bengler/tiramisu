...
describe ImageBundle do
  ...
  describe "#metadata" do
    it "provides an image metadata hash for the client" do
      ...
      expect(metadata[:baseurl]).to eq "https://s3-eu-west-1.amazonaws.com/apps.o5.no/area51/secret/unit/20120306122011-1498-uuva"
      expect(metadata[:original]).to eq "https://s3-eu-west-1.amazonaws.com/apps.o5.no/area51/secret/unit/20120306122011-1498-uuva/original.jpg"
      expect(metadata[:aspect_ratio]).to eq 1.498

      expected_versions = [
        {:width => 100, :square => false, :url => "https://s3-eu-west-1.amazonaws.com/apps.o5.no/area51/secret/unit/20120306122011-1498-uuva/100.jpg"},
        {:width => 100, :square => true, :url => "https://s3-eu-west-1.amazonaws.com/apps.o5.no/area51/secret/unit/20120306122011-1498-uuva/100sq.jpg"},
        {:width => 300, :square => false, :url => "https://s3-eu-west-1.amazonaws.com/apps.o5.no/area51/secret/unit/20120306122011-1498-uuva/300.jpg"},
        {:width => 500, :square => true, :url => "https://s3-eu-west-1.amazonaws.com/apps.o5.no/area51/secret/unit/20120306122011-1498-uuva/500sq.jpg"},
        {:width => 700, :square => false, :url => "https://s3-eu-west-1.amazonaws.com/apps.o5.no/area51/secret/unit/20120306122011-1498-uuva/700.jpg"},
        {:width => 1000, :square => false, :url => "https://s3-eu-west-1.amazonaws.com/apps.o5.no/area51/secret/unit/20120306122011-1498-uuva/1000.jpg"},
        {:width => 1600, :square => false, :url => "https://s3-eu-west-1.amazonaws.com/apps.o5.no/area51/secret/unit/20120306122011-1498-uuva/1600.jpg"},
        {:width => 1920, :square => false, :url => "https://s3-eu-west-1.amazonaws.com/apps.o5.no/area51/secret/unit/20120306122011-1498-uuva/1920.jpg"}
      ]
  ...
  describe "#tootsie_job" do
    it "provides a hash of parameters that can be used to post a transcoding job to tootsie" do
      ...
      expect(tootsie_job[:params][:input_url]).to eq "https://s3-eu-west-1.amazonaws.com/apps.o5.no/area51/secret/unit/20120306122011-1498-uuva/original.jpg"
  ...
  it "does not convert gif to jpeg" do
    ...
    expect(tootsie_job[:params][:input_url]).to match /https:\/\/s3-eu-west-1\.amazonaws\.com\/apps\.o5\.no\/area51\/secret\/unit\/\d+-1498-\w+\/original\.gif/
